...
const ServiceItem = ({ title, icon: Icon, link, delay }) => {
  ...
  return (
    ...
    >
      ...
      <p className="text-[10px] sm:text-xs font-tech text-white/30 uppercase tracking-[0.3em] group-hover:text-white transition-colors">
        {title}
      </p>
    </motion.a>
  );
  ...
  const services = [
    {
      title: "Product",
      icon: Layers,
      link: "https://www.figma.com/proto/DKUmS1Jkd5F7EMOMY1Sca6/Untitled?page-id=0%3A1&node-id=184-160",
    },
    { title: "Web", icon: Monitor, link: "/resource/web_design.pdf" },
    { title: "Logo", icon: PenTool, link: "/resource/logo_design.pdf" },
    {
      title: "Mockups",
      icon: Layout,
      link: "https://www.figma.com/proto/DKUmS1Jkd5F7EMOMY1Sca6/Untitled?page-id=0%3A1&node-id=287-42",
    },
    { title: "Branding", icon: Briefcase, link: "/resource/branding.pdf" },
    {
      title: "Print",
      icon: Printer,
      link: "https://www.figma.com/proto/DKUmS1Jkd5F7EMOMY1Sca6/Untitled?page-id=0%3A1&node-id=297-259",
    },
  ];
