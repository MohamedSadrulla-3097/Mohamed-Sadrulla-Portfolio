...
const ExperienceItem = ({ title, company, period, description, index }) => (
  ...
  >
    ...
    <span className='text-[10px] sm:text-xs text-[#c084fc] font-tech uppercase tracking-[0.2em]'>{period}</span>
    <h3 className='text-base sm:text-lg font-bold text-white mt-1.5 tracking-tight'>{title}</h3>
...
const Experience = () => {
  const experiences = [
    {
      ...
      period: "2020 - 2025",
      description: "Designed promotional materials and handled client design requests. Started self-learning web technologies and implemented personal projects."
    },
    {
      title: "AutoCAD Designer",
      company: "Modine Thermal Systems",
      period: "2019 - 2020",
      description: "Developed precise 2D and 3D technical drawings for thermal system components, ensuring manufacturing accuracy and optimization through CAD modeling."
    },
    {
      title: "Robot Welding Operator",
      company: "Wheels India Pvt Ltd",
      period: "2018 - 2019",
      description: "Operated and maintained production line systems ensuring efficiency and quality control."
    }
  ];
  ...
  return (
    <div className='liquid-glass rounded-[2rem] p-8 sm:p-10 lg:p-12 h-full relative group overflow-hidden'>
      ...
      <h2 className='text-3xl lg:text-4xl font-extralight tracking-tight text-[#c084fc] mb-12'>Experience</h2>
