      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center">
        ...
        >
          <div className="space-y-6">
            <h3 className="text-xl lg:text-2xl font-extralight tracking-tight text-[#c084fc] uppercase tracking-widest">
              Reach Me
            </h3>
            <div className="flex flex-wrap gap-4 justify-center md:justify-start">
              <a
                href="mailto:mohamedsadrulla301097@gmail.com"
                className="bg-white/5 border border-white/10 px-6 py-3.5 rounded-2xl flex items-center group/link hover:border-[#c084fc]/40 transition-all"
              >
                <Mail className="w-4 h-4 mr-3 text-[#c084fc] opacity-40 group-hover/link:opacity-100 transition-opacity" />
                <span className="text-white/40 text-[10px] sm:text-[11px] group-hover/link:text-white transition-colors break-all font-light font-tech tracking-wider">
                  mohamedsadrulla301097@gmail.com
                </span>
              </a>
              <a
                href="https://www.instagram.com/graphic_studio.97"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white/5 border border-white/10 px-6 py-3.5 rounded-2xl flex items-center group/link hover:border-[#c084fc]/40 transition-all"
              >
                <InstagramIcon className="w-4 h-4 mr-3 text-[#c084fc] opacity-40 group-hover/link:opacity-100 transition-opacity" />
                <span className="text-white/40 text-[10px] sm:text-[11px] group-hover/link:text-white transition-colors font-light font-tech tracking-wider">
                  graphic_studio.97
                </span>
              </a>
            </div>
